...
async function seedAllTables() {
    ...
    try {
        ...
        const existingNotifications = allNotifications.filter(n => Array.isArray(n.recipients) && n.recipients.includes(demoDriver.phone));
        ...
        const notificationCount = allNotificationsForCount.filter(n => Array.isArray(n.recipients) && n.recipients.includes(demoDriver.phone)).length;
