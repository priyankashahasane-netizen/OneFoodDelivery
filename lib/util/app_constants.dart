...
class AppConstants {
  ...
  // Smart Path
  static const String generateSmartPathUri = '/api/smart-path/generate';
  static const String getSmartPathUri = '/api/smart-path/driver'; // /:driverId
  static const String getSmartPathByIdUri = '/api/smart-path'; // /:id
